<template>
  <div id="app">
    ...
    <tab-bar>
      ...
      <tab-bar-item path="/shopping" activeColor="gold">
        <img slot="item-icon" src="./assets/img/tabbar/shopping.svg">
        <img slot="item-icon-active" src="./assets/img/tabbar/shopping_active.svg">
